...
namespace Doctor.Web
{
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IDoctorsHandler, DoctorsQueryHandler>();
            services.AddTransient<IPrescriptionServiceClient, PrescriptionServiceClient>();
            services.AddTransient<IMedicalAppointmentServiceClient, MedicalAppointmentServiceClient>();
        }
